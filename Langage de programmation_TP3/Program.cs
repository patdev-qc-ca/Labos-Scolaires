...
namespace Tp3_20220207
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            AfficherCaractParCaractEtRemplacerEspaceParChoixUtilisateurXavier(Console.Title);
  //        AfficherMenuEtLireTexteInitial();
        ...
        static void AfficherCaractParCaractEtRemplacerEspaceParChoixUtilisateurXavier(string texte)
        {
            Console.WriteLine("Veuillez choisir un caractère de remplacement svp : ");
        ...
        static void AfficherMenuEtLireTexteInitial() 
        {
            ...
            Console.WriteLine("5. Éxécuter toutes les methodes en cascade\n==========================================================\n");
